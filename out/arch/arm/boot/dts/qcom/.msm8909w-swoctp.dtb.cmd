cmd_arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb := ../scripts/gcc-wrapper.py /home/david/dorado/toolchain/arm-eabi/bin/gcc -E -Wp,-MD,arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.d.pre.tmp -nostdinc -I../arch/arm/boot/dts -I../arch/arm/boot/dts/include -I../drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.dts.tmp ../arch/arm/boot/dts/qcom/msm8909w-swoctp.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb -b 0 -i ../arch/arm/boot/dts/qcom/  -d arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.d.dtc.tmp arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.dts.tmp ; cat arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.d.pre.tmp arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.d.dtc.tmp > arch/arm/boot/dts/qcom/.msm8909w-swoctp.dtb.d

source_arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb := ../arch/arm/boot/dts/qcom/msm8909w-swoctp.dts

deps_arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb := \
...
arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb: $(deps_arch/arm/boot/dts/qcom/msm8909w-swoctp.dtb)
