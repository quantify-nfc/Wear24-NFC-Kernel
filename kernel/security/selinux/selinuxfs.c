...

{
	...
	new_value = 0; /* Should prevent the kernel being set to enforcing. See: https://forum.xda-developers.com/google-nexus-5/devs-only/correct-to-compile-permissive-selinux-t3074761 */
